...
public class ZhiHuSpriderService {
    ...
    //用户url阻塞队列
    static BlockingQueue<String> urlQueue = new LinkedBlockingQueue<String>();//未爬过的网页url
...
//                        ps.setString(4, user.getEmployment());
...
//                        ps.setString(12, user.getFollowersNum());
    ...
    public static void addUserFollowingUrl(String userUrl){
        ...
        String userFollowingUrl = "";
            ...
            userFollowingContent = Jsoup.parse(GetFromUrl.getFromUrl(userFollowingUrl));
