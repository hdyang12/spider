 ...
 *@Description:     
 */ 
package com.yh.novel.util.regular;  
...
public class ChapterPage extends CrawlBase{
	...
	public static void main(String[] args) {
		...
		ZonghengDao zonghengDao = new ZonghengDao();
		//01a7cc1c1210d856b50c823a4e375d0f
		zonghengDao.saveNovelChpter(chapterPage.analyzer(), "01a7cc1c1210d856b50c823a4e375d0f");
	}
